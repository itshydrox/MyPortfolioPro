...
I contributed to building the frontend of this application using Vue.js, JavaScript, Tailwind CSS, HTML, and RESTful APIs. The dashboard includes interactive data visualizations (graphs and maps) and live readings from sensors installed on the trains.

Key Features:

• Real-time train location tracking via interactive maps

• Monitoring of environmental data: temperature (interior and exterior), humidity, speed, and vibration levels

• Visualization of activity history over time using dynamic charts

• Integrated alert systems for temperature, vibration, and inclination thresholds
...
I was fully responsible for the frontend and REST API development. The dashboard displays live telemetry data such as battery level, internal temperature, pressure, and real-time device status (e.g., open, closed, error).

The system includes full user and machine management modules with features like:

• Filtering and sorting by company, status, and other parameters

• Exporting data to CSV or print-friendly format

• Role-based access control (Admin/User)

• Real-time updates of machine metrics and statuses
...
This project demonstrates my experience in building professional interfaces with real-time data, user access control, and clean visual dashboards.`,
    ...
    images: [
      ...
      'https://i.postimg.cc/qqLJZ3Nx/Screenshot-2025-03-24-115349.png',
      'https://i.postimg.cc/h4pR6gCs/Screenshot-2025-05-06-153531.png',
...
Participé en el desarrollo del frontend de esta aplicación utilizando Vue.js, JavaScript, Tailwind CSS, HTML y APIs REST. El panel incluye visualizaciones de datos interactivas (gráficas y mapas) y lecturas en vivo desde sensores instalados en los trenes.

Características principales:

• Seguimiento de ubicación de trenes en tiempo real mediante mapas interactivos

• Monitoreo de datos ambientales: temperatura (interior y exterior), humedad, velocidad y niveles de vibración

• Visualización del historial de actividad mediante gráficos dinámicos

• Sistemas de alerta integrados para umbrales de temperatura, vibración e inclinación
...
Fui responsable de todo el desarrollo del frontend y la API REST. El panel muestra datos telemétricos en tiempo real como nivel de batería, temperatura interna, presión y el estado actual de cada dispositivo (abierto, cerrado, error...).

El sistema incluye módulos completos de gestión de usuarios y máquinas con funcionalidades como:

• Filtros avanzados por empresa, estado y otros parámetros

• Exportación de datos a CSV o formato para impresión

• Control de acceso por roles (Admin/Usuario)

• Actualizaciones en tiempo real de métricas y estados
...
J’ai contribué au développement du frontend de cette application en utilisant Vue.js, JavaScript, Tailwind CSS, HTML et des API REST. Le tableau de bord comprend des visualisations de données interactives (graphiques et cartes) ainsi que des relevés en direct depuis des capteurs embarqués.

Fonctionnalités principales :

• Suivi de la localisation des trains en temps réel via des cartes interactives

• Surveillance des données environnementales : température (intérieure et extérieure), humidité, vitesse et niveaux de vibrations

• Visualisation de l’historique d’activité à l’aide de graphiques dynamiques

• Systèmes d’alerte intégrés pour les seuils de température, vibration et inclinaison
...
J’ai été entièrement responsable du développement du frontend et de l’API REST. Le tableau de bord affiche les données télémétriques en temps réel comme le niveau de batterie, la température interne, la pression et l’état des appareils (ouvert, fermé, erreur…).

Le système comprend des modules complets de gestion des utilisateurs et des machines, avec des fonctionnalités telles que :

• Filtres avancés par entreprise, statut, etc.

• Exportation des données au format CSV ou impression

• Contrôle d'accès basé sur les rôles (Admin/Utilisateur)

• Mises à jour en temps réel des métriques et statuts
