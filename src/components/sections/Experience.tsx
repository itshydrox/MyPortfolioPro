...
import { Calendar, Briefcase, Terminal, Code2 } from 'lucide-react';
            ...
            >
              ...
              <div className="p-7">
                ...
                <div className="space-y-3 pl-5 border-l-2 border-cyan-500/30 dark:border-cyan-400/30 mb-5">
                  ...
                  >
                    <Briefcase size={16} className="text-cyan-500 dark:text-cyan-400" />
                    <span className="font-mono text-base text-slate-700 dark:text-gray-300 font-medium">{experience.company}</span>
                  </motion.div>
