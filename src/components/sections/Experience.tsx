...
const Experience: React.FC = () => {
  ...
  return (
    <Section
      ...
      className="bg-gradient-to-b from-white via-blue-50/10 to-white dark:from-gray-950 dark:via-blue-950/10 dark:to-gray-900"
    >
      <div className="max-w-10xl mx-auto relative">
        ...
        {localizedExperiences.map((experience, index) => (
          ...
          >
            {/* Timeline dot */}
            <div 
              className={`absolute left-7 md:left-1/2 top-8 w-3 h-3 rounded-full bg-blue-500 transform
                ${index % 2 === 0 
                  ? 'md:-translate-x-1/2' 
                  : 'md:-translate-x-1/2'
                }`}
            >
              ...
              <div className="absolute -inset-1 rounded-full bg-blue-500/40" />
            </div>
          ...
          >
                <div className="relative">
                  ...
                  {/* Main circle */}
                  <div className="relative h-11 w-11 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-400 dark:to-blue-500 p-[2px]">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                <motion.h3 
                  ...
                  viewport={{ once: true }}
                  className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent"
                >
                  {experience.role}
                </motion.h3>
                <motion.div 
              ...
              >
                <Briefcase size={20} className="mr-3 text-blue-500 dark:text-blue-400" />
              ...
              >
                ...
                <ul className="space-y-4">
                  {experience.achievements.map((achievement, i) => (
                    ...
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-blue-500 dark:bg-blue-400 mt-2 mr-4 flex-shrink-0 group-hover:scale-150 transition-transform duration-300" />
              ...
              >
                {experience.technologies.map((tech, i) => (
                  <motion.span
                    ...
                    className="px-4 py-1.5 text-sm rounded-full bg-blue-50 dark:bg-blue-900/30 
                      text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-800
                      hover:bg-blue-100 dark:hover:bg-blue-800/40 transition-colors duration-300"
                  >
                    {tech}
                  </motion.span>
                ))}
