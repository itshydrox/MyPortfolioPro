...
const CompanyProjects: React.FC = () => {
  ...
  const [selectedProject, setSelectedProject] = useState<typeof companyProjects.en[0] | null>(null);
  ...
  const projectsData = companyProjects[language as keyof typeof companyProjects] || companyProjects.en;
